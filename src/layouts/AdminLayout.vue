...
export default {
  ...
  methods: {
    ...
    handleResize() {
      const wide = window.innerWidth > 991;
      if (wide && !this.sidebarVisible) this.sidebarVisible = true;
      if (!wide && this.sidebarVisible) this.sidebarVisible = false;
    },
  },
};
</script>
